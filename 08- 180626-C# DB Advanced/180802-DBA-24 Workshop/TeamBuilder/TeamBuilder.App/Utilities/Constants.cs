namespace TeamBuilder.App.Utilities
{
    public static class Constants
    {
        ...
        public static class ErrorMessages
        {
            ...
            public const string InvalidEventArgs = "Invalid Name or Description argument";
            public const string NotMemberOfTeam = "User {0} is not a member in {1}!";
            public const string CantKickCreatorOfTeam = "Command not allowed. Use DisbandTeam instead.";
