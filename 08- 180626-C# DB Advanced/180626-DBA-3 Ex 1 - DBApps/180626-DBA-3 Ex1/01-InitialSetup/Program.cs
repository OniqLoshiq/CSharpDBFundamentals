    ...
    class Program
    {
        static void Main(string[] args)
        {
            using (SqlConnection connection = new SqlConnection(Configuration.ConnectionString))
            {
                ...
                ExecuteNonQuery(connection, insertVillians);
                ...
                ExecuteNonQuery(connection, insertMinionsVillians);
                
                connection.Close();
            }
        }

        private static void ExecuteNonQuery(SqlConnection connection, string sqlCommand)
        {
